			...
			<form method="post" action="captcha-check.php">
				<fieldset>
					...
					<div class="field">
						...
						<div>
							<a href="" onclick="document.getElementById('captcha-image').setAttribute('src', 'captcha.php?type=Mathematical&amp;r=' + Math.floor(Math.random() * 10000)); return false;">Reload</a>
						</div>
